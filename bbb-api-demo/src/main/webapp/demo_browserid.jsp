...
<head>
	...
	<title>Join Demo Meeting using BrowserID</title>
...
<h2>Join Demo Meeting using BrowserID</h2>
...
<%
	...
	try{
		...
		data += "&" + URLEncoder.encode("audience", "UTF-8") + "=" + URLEncoder.encode("http://10.250.2.215", "UTF-8");
